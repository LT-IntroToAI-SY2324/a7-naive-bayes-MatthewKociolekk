...
if __name__ == "__main__":
    ...
    print(b.classify("I am so happy it's almost summer "))
    print(b.classify("This movie was so good It was the best thing i ever watched "))
    print(b.classify("I real loved that show, it was really funny and i liked it a lot"))
    pass